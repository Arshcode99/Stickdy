...
import HeroImg from '../public/Stickers For Everyone.png';
import Script from 'next/script'

export default function Home() {
  return (
    <>
      <section className='w-full h-min flex items-center flex-col mb-5'>
        <Image src={HeroImg} className='rounded-lg' />
        </section>
          <section class="text-gray-600 body-font  mb-5">
            <div class="container px-5 py-24 mx-auto">
              ...
              <div class="flex flex-wrap -m-4 flex flex-row justify-center items-center">
              ...
              <div className='flex flex-row justify-center items-center'><button type="button" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mx-auto">Explore</button></div>
            </div>
          </section>
    </>
  )
